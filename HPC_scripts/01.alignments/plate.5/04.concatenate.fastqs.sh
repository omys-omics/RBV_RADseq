...
cd BJW-MSG-NdeI-P1-96-UDI-01_S1_R1_001
fastqs=`ls *.fq`
cd ..
...
for f in $fastqs
do
  cat ../BJW-MSG-NdeI-P1-96-UDI-01_S1_R1_001/$f ../BJW-MSG-NdeI-P1-96-UDI-02_S2_R1_001/$f ../BJW-MSG-NdeI-P1-96-UDI-04_S3_R1_001/$f> $f
  echo "Processed:" $f
done
