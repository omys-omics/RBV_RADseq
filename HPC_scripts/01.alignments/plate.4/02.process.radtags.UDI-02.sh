...
mkdir BJW-MSG-NdeI-P1-80-UDI-02_S2_R1_001


process_radtags \
-f /panfs/pfs.local/work/colella/ben/004.RBV.rad/01.raw.reads/plate.4/BJW-MSG-NdeI-P1-80-UDI-02_S2_R1_001.fastq.gz \
-o BJW-MSG-NdeI-P1-80-UDI-02_S2_R1_001/ \
-b plate.4.barcodes.txt \
