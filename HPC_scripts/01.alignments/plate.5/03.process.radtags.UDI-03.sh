...
mkdir BJW-MSG-NdeI-P1-96-UDI-04_S3_R1_001


process_radtags \
-f /panfs/pfs.local/work/colella/ben/004.RBV.rad/01.raw.reads/plate.5/BJW-MSG-NdeI-P1-96-UDI-04_S3_R1_001.fastq.gz \
-o BJW-MSG-NdeI-P1-96-UDI-04_S3_R1_001/ \
