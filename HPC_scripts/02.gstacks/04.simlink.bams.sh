...
##################    NEW PATHS WHEN KU UPDATED TO ROCKY

mkdir 04.simlink.bams
...
do
  ln -s /kuhpc/work/colella/ben/004.RBV.rad/02.plate.1.analyses/03.align.reads/01.basic.fastqs/01.alignments/alignment_$cat_num/$cat_num.sorted.bam ./04.simlink.bams
done

# simlink all the samples from the third plate
ln -s /kuhpc/work/colella/ben/004.RBV.rad/04.plate.3.analyses/02.align.reads/01.alignments/alignment_*/*sorted.bam ./04.simlink.bams
...
do
  ln -s /kuhpc/work/colella/ben/004.RBV.rad/06.plate.4.analyses/02.align.reads/01.alignments/alignment_$cat_num/$cat_num.sorted.bam ./04.simlink.bams
done

# simlink all the samples from the fifth plate
ln -s /kuhpc/work/colella/ben/004.RBV.rad/08.plate.5.analyses/02.align.reads/01.alignments/alignment_*/*sorted.bam ./04.simlink.bams