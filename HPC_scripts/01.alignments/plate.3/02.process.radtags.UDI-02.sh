...
mkdir BJW-MSG-NdeI-P1-70C-UDI-02_S2_R1_001


process_radtags \
-f /panfs/pfs.local/work/colella/ben/004.RBV.rad/01.raw.reads/plate.3/BJW-MSG-NdeI-P1-70C-UDI-02_S2_R1_001.fastq.gz \
-o BJW-MSG-NdeI-P1-70C-UDI-02_S2_R1_001/ \
-b plate.3.barcodes.txt \
