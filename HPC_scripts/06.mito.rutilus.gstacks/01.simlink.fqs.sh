...
do
  ln -s /kuhpc/work/colella/ben/004.RBV.rad/02.plate.1.analyses/01.process.radtags/BJW-MSG-NdeI-P1-70_S1_R1_001/$cat_num.fq ./01.simlink.fqs
done

# simlink all the samples from the third plate
ln -s /kuhpc/work/colella/ben/004.RBV.rad/04.plate.3.analyses/01.process.radtags/04.concatenated.fastqs/*.fq ./01.simlink.fqs
# get rid of UAM50293 because it is sequenced better on the 5th plate
rm 01.simlink.fqs/UAM50293.fq
...
do
  ln -s /kuhpc/work/colella/ben/004.RBV.rad/06.plate.4.analyses/01.process.radtags/04.concatenated.fastqs/$cat_num.fq ./01.simlink.fqs
done

# simlink all the samples from the fifth plate
ln -s /kuhpc/work/colella/ben/004.RBV.rad/08.plate.5.analyses/01.process.radtags/04.concatenated.fastqs/*.fq ./01.simlink.fqs