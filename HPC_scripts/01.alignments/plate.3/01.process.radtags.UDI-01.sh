...
mkdir BJW-MSG-NdeI-P1-70C-UDI-01_S1_R1_001


process_radtags \
-f /panfs/pfs.local/work/colella/ben/004.RBV.rad/01.raw.reads/plate.3/BJW-MSG-NdeI-P1-70C-UDI-01_S1_R1_001.fastq.gz \
-o BJW-MSG-NdeI-P1-70C-UDI-01_S1_R1_001/ \
