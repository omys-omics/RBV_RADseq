...
process_radtags \
-f /panfs/pfs.local/work/colella/ben/004.RBV.rad/01.raw.reads/plate.1/BJW-MSG-NdeI-P1-70_S1_R1_001.fastq.gz \
-o BJW-MSG-NdeI-P1-70_S1_R1_001/ \
-b plate.1.barcodes.txt \
